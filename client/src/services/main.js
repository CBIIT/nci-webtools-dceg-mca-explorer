...
window.onload=function() {
  const track0 = document.querySelectorAll('.track-0 .block');
  const track1 = document.querySelectorAll('.track-1 .block');
  const track2 = document.querySelectorAll('.track-2 .block');
  const track3 = document.querySelectorAll('.track-3 .block');
