...
export default function CirclePlotTest(props) {
  ...
  const data = [
    {name: 'A', value:0,end:20,type:"GAIN"},
    {name: 'E', value:0,end:25,type:"GAIN"},
    {name: 'B', value:20,end:30,type:"GAIN"},
    {name: 'C', value:30,end:35,type:"GAIN"},
    {name: 'D', value:40,end:45,type:"GAIN"},
    {name: 'A1', value:0,end:20,type:"GAIN"},
    {name: 'E1', value:0,end:28,type:"LOSS"},
    {name: 'B1', value:20,end:25,type:"LOSS"},
    {name: 'C1', value:30,end:36,type:"LOSS"},
    {name: 'D1', value:40,end:55,type:"LOSS"},
    {name: 'A2', value:10,end:30,type:"LOSS"},
    {name: 'E2', value:18,end:20,type:"LOSS"},
    {name: 'B2', value:20,end:28,type:"LOSS"},
    {name: 'C2', value:30,end:35,type:"NEUTRAL"},
    {name: 'D2', value:40,end:60,type:"NEUTRAL"},
    {name: 'A3', value:10,end:20,type:"NEUTRAL"},
    {name: 'E3', value:18,end:20,type:"NEUTRAL"},
    {name: 'B3', value:20,end:55,type:"NEUTRAL"},
    {name: 'C3', value:30,end:50,type:"UNDETERMIND"},
    {name: 'D3', value:40,end:60,type:"UNDETERMIND"},
]
  return (
